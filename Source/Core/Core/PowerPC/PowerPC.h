...
// In mainline Dolphin, this is "Core/PowerPC/BreakPoints.h". It's been retrofitted
// here to fit pre-existing Ishiiruka conventions.
...
// In mainline Dolphin this is `enum class CoreMode`, but it's reverted here to match existing
// Ishiiruka types.
enum CoreMode
{
  MODE_INTERPRETER,
