...
static const u8* gdsp_ddma_in(u16 dsp_addr, u32 addr, u32 size)
{
  ...
  {
        // In mainline Dolphin, this is a separate method tied to some defined constants that
        // don't exist in Ishiiruka. This has been inlined to avoid needing those constants.
